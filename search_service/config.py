...
ELASTICSEARCH_TABLE_INDEX_KEY = 'ELASTICSEARCH_TABLE_INDEX'
ELASTICSEARCH_DASHBOARD_INDEX_KEY = 'ELASTICSEARCH_DASHBOARD_INDEX'
ELASTICSEARCH_METRIC_INDEX_KEY = 'ELASTICSEARCH_METRIC_INDEX'
...
class Config:
    ...
    ELASTICSEARCH_TABLE_INDEX = 'tables_alias'
    ELASTICSEARCH_DASHBOARD_INDEX = 'dashboards_alias'
    ELASTICSEARCH_METRIC_INDEX = 'metrics_alias'
